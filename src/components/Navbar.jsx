...
const Navbar = () => {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 border-b border-white/10 bg-slate-950/80 backdrop-blur-xl">
      <div className="flex justify-between px-4 py-4 md:flex-row md:items-center md:justify-between md:px-10">

        {/* Logo */}
        <div className="flex items-center gap-2">
          <div className="flex h-8 w-8 text-lg sm:h-9 sm:w-9 sm:text-lg items-center justify-center rounded-xl bg-violet-600 font-bold shadow-lg shadow-violet-600/30">
            ✦
          </div>

          <h1 className="text-[25px] sm:text-[28px] font-bold tracking-tight text-white">
